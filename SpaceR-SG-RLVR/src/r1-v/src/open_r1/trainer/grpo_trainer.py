...
class Qwen2VLGRPOTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        if inputs[0]['data_type'] == 'image':
            input_copy[0]['content'][0]['image'] = inputs[0]['path']#os.getcwd() + "/Video-R1-data" + inputs[0]['path'][1:] 
        elif inputs[0]['data_type'] == 'video':
            input_copy[0]['content'][0]['video'] = inputs[0]['path']#os.getcwd() + "/Video-R1-data" + inputs[0]['path'][1:] 
        ...
        try:
            ...
            if inputs[0]['data_type'] == 'image':
                input_copy[0]['content'][0]['image'] = inputs[0]['path']#os.getcwd() + "/Video-R1-data" + '/Math/Multimath-300k/17ff4c7d14c388134de02381b1fc2824.png'
            elif inputs[0]['data_type'] == 'video':
                input_copy[0]['content'][0]['video'] = inputs[0]['path']#os.getcwd() + "/Video-R1-data" + '/LLaVA-Video-178K/liwei_youtube_videos/videos/youtube_video_2024/ytb_7nRmsEw7nsE.mp4'
